...
use sans_io_runtime::{
    group_owner_type, Controller, TaskGroupOwner, WorkerInner, WorkerInnerInput, WorkerInnerOutput,
};
...
fn main() {
    ...
    controller.add_worker::<SimpleOwner, _, EchoWorker, PollBackend<_, 16, 1024>>(
